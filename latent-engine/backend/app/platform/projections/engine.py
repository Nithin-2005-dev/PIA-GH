...
from app.adapters.database.provider import PersistenceProvider
from app.platform.projections.registry import ProjectionRegistry, ProjectionDefinition, get_projection_registry
from app.platform.events.store import ImmutableEventStore, StoreEvent, EventType, get_event_store
...
def get_projection_engine(
    ...
    global _engine
    if _engine is None:
        from app.adapters.database.sqlite_provider import get_provider as _get_provider
        ...
        from app.platform.projections.engine import _register_stub_builders
...
def _register_stub_builders(engine: ProjectionEngine) -> None:
    ...
    class StubBuilder(ProjectionBuilder):
        ...
        def build(self, provider, incremental=True, affected_object_ids=None):
            ...
            try:
                from app.adapters.database.models import MeasurementRecord, EvidenceRecord, DeveloperRecord
                result.record_count = (
